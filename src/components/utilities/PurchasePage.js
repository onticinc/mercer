                ...
                <div className="column is-4 is-offset-4">
                  <div className="box">
                    <form>
                      ...
                      <a id="editProfile" className="button is-block is-fullwidth is-primary is-medium" href="/viewothersales">Browse Other Sales<i className="fa fa-sign-in" aria-hidden="true"></i></a>
